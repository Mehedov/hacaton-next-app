...
const InteractiveTooltips: React.FC<InteractiveTooltipsProps> = ({
	...
	return (
		<div className='fixed right-0 top-0 h-full w-96 bg-white shadow-2xl border-l-2 pointer-events-auto z-50'>
			{/* Заголовок панели */}
			<div className='p-4 border-b bg-gray-50'>
				<div className='flex items-center justify-between'>
					...
					<button
						onClick={() => {
							window.dispatchEvent(new CustomEvent('close-tooltips'))
						}}
						className='w-8 h-8 bg-red-500 hover:bg-red-600 text-white rounded-full flex items-center justify-center font-bold transition-colors duration-200'
					>
						×
					</button>
				</div>
				...
				{currentTooltip && (
					<div className='space-y-4'>
						...
						<div className='bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400'>
							<h5 className='font-semibold text-gray-800 mb-2'>📖 Простое объяснение:</h5>
						...
						<div className='flex justify-center'>
							...
							>
								{showTechnical ? '📖 Простое объяснение' : '🔬 Технические детали'}
							</button>
						</div>
						...
						{showTechnical && (
							<div className='bg-gray-50 p-4 rounded-lg border-l-4 border-gray-400'>
								<h5 className='font-semibold text-gray-800 mb-2'>🔬 Технические детали:</h5>
						...
						<div className='bg-green-50 p-4 rounded-lg border-l-4 border-green-400'>
							<h5 className='font-semibold text-gray-800 mb-3'>💡 Примеры:</h5>
						...
						<div className='bg-white border rounded-lg p-4'>
							<h5 className='font-semibold text-gray-800 mb-3'>🔄 Навигация по этапам:</h5>
						...
						<div className='bg-gray-50 rounded-lg p-4'>
							<h5 className='font-semibold text-gray-800 mb-3'>📋 Все этапы процесса:</h5>
